...
const he = {
  ...
  settings: { title: "הגדרות", placement: "מיקום", right: "ימין", left: "שמאל", top: "למעלה", monitor: "צג", language: "שפה", fullscreen: "הצג תמיד מעל יישומים במסך מלא", startup: "הפעל בעת האתחול", display: "תצוגה", providers: "ספקים", diagnostics: "אבחון", diagnosticsHint: "יומן מקומי של רענוני הספקים: איזה CLI רץ, כמה זמן, והאם הצליח. ללא פלט וללא סודות.", openLogFolder: "פתח את תיקיית היומן" },
